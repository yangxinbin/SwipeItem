...
public class SwipeItemLayout_r extends ViewGroup {
    enum Mode{
    ...
    public SwipeItemLayout_r(Context context) {
        this(context,null);
    }

    public SwipeItemLayout_r(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private class ScrollRunnable implements Runnable{
        ...
        void startScroll(int startX,int endX){
            if(startX!=endX){
                ...
                ViewCompat.postOnAnimation(SwipeItemLayout_r.this,this);
            }
        }
    ...
    public static class OnSwipeItemTouchListener implements RecyclerView.OnItemTouchListener {
        private SwipeItemLayout_r captureItem;
        ...
        public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent ev) {
            ...
            switch (action){
                case MotionEvent.ACTION_DOWN:{
                    ...
                    SwipeItemLayout_r pointItem = null;
                    //首先知道ev针对的是哪个item
                    View pointView = findTopChildUnder(rv,(int)x,(int)y);
                    if(pointView==null || !(pointView instanceof SwipeItemLayout_r)){
                        //可能是head view或bottom view
                        pointOther = true;
                    }else
                        pointItem = (SwipeItemLayout_r) pointView;
